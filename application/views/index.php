...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="<?php echo base_url();?>assets/css/style.css" />
   ...
   <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/admin/icon/iconrb16.ico">
...
<body>
  ...
  <header id="home">
    <!-- Background Image -->
    <div class="bg-img" style="background-image: url('<?php echo base_url();?>assets//img/background1.jpg');">
        ...
        <div class="navbar-header">
          ...
          <div class="navbar-brand">
            <a href="index.html">
              ...
              <img class="logo-alt" src="<?php echo base_url();?>assets/img/logo-alt.png" alt="logo">
            </a>
          </div>
          <!-- /Logo -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="footer-logo">
            <a href="index.html"><img src="<?php echo base_url();?>assets/img/logo-alt.png" alt="logo"></a>
          </div>
          <!-- /footer logo -->
          ...
          <div class="footer-copyright">
            <p>Copyright © 2018 Ribonhouse. All Rights Reserved</p>
